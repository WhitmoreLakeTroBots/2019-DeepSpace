...
class AutonRight_HR2_HCR extends BaseAutonGenerator {

  AutonRight_HR2_HCR (Trajectory.Config conf) {
    this.config = conf;
    baseFileName = this.getClass().getSimpleName();
    gnuPlotString = "plot '%s' using 2:3 w lp lt rgb 'gold'";
  }

  private Trajectory gen_Auton_HR2_HCR_01() {
		Waypoint[] points = new Waypoint[] {
      new Waypoint(1.50, 3.00, Pathfinder.d2r(0)),
      new Waypoint(5.00, 2.00, Pathfinder.d2r(-15)),
      new Waypoint(7.18, 2.80, Pathfinder.d2r(90)),
      new Waypoint(7.18, 3.30, Pathfinder.d2r(90))
		};
		return (Pathfinder.generate(points, config));
    }

    private Trajectory gen_Auton_HR2_HCR_02(){
      Waypoint[] points = new Waypoint[] {
        new Waypoint(7.18, 3.30, Pathfinder.d2r(-90)),
        new Waypoint(7.18, 2.80, Pathfinder.d2r(-90)),
    ...
    private Trajectory gen_Auton_HR2_HCR_03(){
      Waypoint[] points = new Waypoint[] {
    ...
    private Trajectory gen_Auton_HR2_HCR_04(){
      Waypoint[] points = new Waypoint[] {
  ...
  void generate () {
    segments.add (gen_Auton_HR2_HCR_01());
    segments.add (gen_Auton_HR2_HCR_02());
    segments.add (gen_Auton_HR2_HCR_03());
    segments.add (gen_Auton_HR2_HCR_04());
    write();
  }
}
