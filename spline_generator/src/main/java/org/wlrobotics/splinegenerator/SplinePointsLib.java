...
class SplinePointsLib {
    ...
    //Start Locations
    public static final Waypoint startCenter = new Waypoint (2.22, 4.00, Pathfinder.d2r(0));
    public static final Waypoint startLeft = new Waypoint (2.22, 5.12, Pathfinder.d2r(0));
    public static final Waypoint startLeft2 = new Waypoint (0.28, 5.12, Pathfinder.d2r(0));
    public static final Waypoint startRight = new Waypoint (2.22, 2.88, Pathfinder.d2r(0));
    public static final Waypoint startRight2 = new Waypoint (0.28, 2.88, Pathfinder.d2r(0));
    public static final Waypoint startCenterL = new Waypoint (2.22, 4.25, Pathfinder.d2r(0));
    public static final Waypoint startCenterR = new Waypoint (2.22, 3.75, Pathfinder.d2r(0));
